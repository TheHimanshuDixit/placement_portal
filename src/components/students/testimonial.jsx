            ...
            <div
              ...
              <div className="flex flex-wrap justify-center">
                <div className="w-full shrink-0 grow-0 basis-auto px-3 lg:w-8/12">
                  ...
                  <p className="mb-6 text-neutral-500 dark:text-neutral-300">
                    Thanks to the exceptional support and resources provided by
                    our college's training and placement website, I successfully
                    secured a position as a Software Development Engineer at
                    Google. The platform's seamless interface and invaluable
                    guidance played a pivotal role in navigating the application
                    process with confidence. I am immensely grateful for the
                    opportunities it provided, shaping my career trajectory and
                    propelling me towards success.
                  </p>
                  <ul className="mb-0 flex justify-center">
                    <li>
                      <svg
              ...
              <div className="flex flex-wrap justify-center">
                <div className="w-full shrink-0 grow-0 basis-auto px-3 lg:w-8/12">
                  ...
                  <p className="mb-6 text-neutral-500 dark:text-neutral-300">
                    ...
                    recently landed a role as a Software Development Engineer at
                    Kickdrum. The user-friendly interface and expert advice
                    provided by the platform were instrumental in guiding me
                    through the application process with ease and assurance. I'm
                    deeply appreciative of the opportunities it afforded me, as
                    they've truly molded my career path and propelled me towards
                    achieving my goals.
                  </p>
                  <ul className="mb-0 flex justify-center">
                    <li>
